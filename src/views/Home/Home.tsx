  ...
  return (
    <BaseRouteOnly baseRoute='/home'>
      <Box w='50%' m='auto'>
        ...
        <HStack>
          <Image mr='2' boxSize='75' src='/home/home-2.png' alt='home 2 logo' />
          <Text fontSize='16'>
        ...
        <HStack>
          <Image mr='2' boxSize='75' src='/home/home-3.png' alt='home 3 logo' />
          <Text fontSize='16'>
            <Text as='b'>Collaboration: </Text> Willing and able to coordinate
            on every aspect of your needs
          </Text>
        </HStack>

        <HStack>
          <Image mr='2' boxSize='75' src='/home/home-4.png' alt='home 4 logo' />
          <Text fontSize='16'>
        ...
        <HStack>
          <Image mr='2' boxSize='75' src='/home/home-5.png' alt='home 5 logo' />
          <Text fontSize='16'>
        ...
        <HStack>
          <Image mr='2' boxSize='75' src='/home/home-6.png' alt='home 6 logo' />
          <Text fontSize='16'>
